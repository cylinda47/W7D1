...
var _todo_api_util = __webpack_require__(89);

var APIUtil = _interopRequireWildcard(_todo_api_util);

var _error_actions = __webpack_require__(90);
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    return APIUtil.createTodo(todo).then(dispatch((0, _error_actions.clearErrors)())).then(function (todo) {
...
var updateTodo = exports.updateTodo = function updateTodo(todo) {
  return function (dispatch) {
    return APIUtil.updateTodo(todo).then(function (todo) {
      return dispatch(receiveTodo(todo));
    });
  };
};
...
var deleteTodo = exports.deleteTodo = function deleteTodo(todo) {
  return function (dispatch) {
    APIUtil.deleteTodo(todo).then(function (response) {
...
var configureStore = (0, _redux.createStore)(_root_reducer2.default, (0, _redux.applyMiddleware)(_thunk.createThunkMiddleware, _reduxLogger2.default));
...
var _error_reducer = __webpack_require__(180);
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.REMOVE_TODO:
      var rTodo = (0, _merge2.default)({}, state);
...
exports.deleteTodo = exports.updateTodo = exports.createTodo = exports.fetchTodos = undefined;
...
var createThunkMiddleware = exports.createThunkMiddleware = function createThunkMiddleware(_ref) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          todos.map(function (todo) {
            return _react2.default.createElement(_todo_list_item2.default, { deleteTodo: deleteTodo, receiveTodo: receiveTodo, updateTodo: updateTodo, todo: todo, key: todo.id });
          })
        ),
        _react2.default.createElement(_todo_form2.default, { receiveTodo: receiveTodo, createTodo: createTodo, errors: this.props.errors })
      );
    }
  }]);
...
var TodoListItem = function TodoListItem(_ref) {
  ...
  var status = function status() {
    return todo.done === false ? true : false;
  };
  ...
  var statusFlipped = function statusFlipped(e) {
    todo.done = status();
    e.preventDefault();
    updateTodo(todo);
  };
...
var _error_list = __webpack_require__(179);
...
var TodoForm = function (_React$Component) {
  ...
  function TodoForm(props) {
    ...
    _this.createTodo = _this.props.createTodo.bind(_this);
  ...
  _createClass(TodoForm, [{
    ...
    value: function updateInput(event) {
      ...
      this.setState(_defineProperty({}, key, data));
    }
  }, {
    key: 'submitItem',
    value: function submitItem(event) {
      ...
      this.createTodo({ todo: todo }).then(function () {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { id: 'title', type: 'text', onChange: this.updateInput, placeholder: 'walk to store', value: this.state.title }),
        ...
        _react2.default.createElement('textarea', { id: 'body', type: 'text', onChange: this.updateInput, placeholder: 'walk to store', value: this.state.body }),
        _react2.default.createElement('br', null),
