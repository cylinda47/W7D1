      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          todos.map(function (todo) {
            return _react2.default.createElement(_todo_list_item2.default, { removeTodo: removeTodo, receiveTodo: receiveTodo, todo: todo, key: todo.id });
          })
        ),
...
var TodoListItem = function TodoListItem(_ref) {
  ...
  var status = function status() {
    return todo.done === 'Undo' ? 'Done' : 'Undo';
  };
...
var TodoForm = function (_React$Component) {
  ...
  function TodoForm(_ref) {
    ...
    _this.state = { title: '', description: '', id: new Date().getTime(), done: 'Undo' };
  ...
  _createClass(TodoForm, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { id: 'title', type: 'text', onChange: this.updateInput, placeholder: 'walk to store' }),
        ...
        _react2.default.createElement('input', { id: 'description', type: 'text', onChange: this.updateInput, placeholder: 'walk to store' }),
        _react2.default.createElement('br', null),
